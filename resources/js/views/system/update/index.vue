    ...
    <div class="row">
        <div class="card col-md-12">
            <div class="card-header justify-content-center d-block">
                ...
                <p class="text-right mb-0 mt-2"><a href="" class="text-info" target="BLANK">Actualización alternativa con script</a></p>
                <p class="text-right mb-0 mt-2">
                    <el-tooltip content="Instalaciones anteriores de Mayo 2020" placement="top">
                        <a href="" class="text-info" target="BLANK">Configuación para disponer de actualiciones automáticas</a>
                    </el-tooltip>
                </p>
            </div>
            <div class="card-body">
